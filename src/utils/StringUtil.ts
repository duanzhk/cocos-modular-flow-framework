...
export class StringUtil {
     ...
     * @param len 
     */
    static ellipsisString(str: string, maxChars: number) {
        if (this.isEmptyOrWhiteSpace(str)) return ""
     ...
     * @returns 
     */
    public static findAllSubstringsIndexes(mainStr: string, subStr: string): number[] {
     ...
     * @returns 
     */
    public static surroundLTRWithUnicode(text: string): string {
