...
!Array.prototype.__cc_extended && Object.defineProperties(Array.prototype, {
    remove: {
        value: function (filter: (arg0: any, arg1: number, arg2: any) => any) {
    ...
    max: {
        value: function (mapper: (arg0: any, arg1: number, arg2: any) => any) {
            if (!this.length) {
                return null;
            }
    ...
    distinct: {
        value: function () {
            return this.filter(function (v: any, i: any, arr: string | any[]) { return arr.indexOf(v) === i; });
        }
    },
    filterIndex: {
        value: function (filter: (arg0: any, arg1: number, arg2: any) => any) {
    ...
    binarySearch: {
        value: function (value: number, keyMapper: (arg0: any) => any) {
    ...
    binaryInsert: {
        value: function (item: any, keyMapper: ((arg0: any) => any) | undefined, unique: boolean) {
    ...
    binaryDistinct: {
        value: function (keyMapper: any) {
            return this.filter(function (v: any, i: any, arr: any[]) { return arr.binarySearch(v, keyMapper) === i; });
        }
    },
    findLast: {
        value: function (predicate: (arg0: any, arg1: number, arg2: any) => any) {
            for (let i = this.length - 1; i > -1; --i) {
    ...
    groupBy: {
        value: function (grouper: (arg0: any) => any) {
            let group = this.reduce(function (prev: { [x: string]: any[]; }, next: any) {
