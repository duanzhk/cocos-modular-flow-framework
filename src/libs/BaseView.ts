...
export abstract class BaseView extends Component implements IView {
    ...
    //broadcast代理对象
    private _eventProxy?: Broadcaster;
                ...
                get: (target, prop) => {
                    if (prop === 'on' || prop === 'once') {
                        return (keyOrHandler: any, listener?: any, context?: any, args?: any[]) => {
                            ...
                            return (target as any)[prop](keyOrHandler, listener, context, args);
                        };
                    }
    ...
    //loader代理对象
    private _loaderProxy?: ResLoader
    ...
    */
    ...
    public __exit__() {
        ...
        this._eventHandlers = [];
        this.__config__?.onExitCallback?.(this);
    }
